...
```yaml
- text: 🐦
- heading "Join MediaVerse" [level=1]
- paragraph: Create, share, and connect with the world.
...
- text: Username @
- textbox "johndoe": e2euser_1783229627073
- text: Email
- textbox "name@example.com": e2e_reg_1783229627073@test.com
- text: Password
