  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      >
        ...
        {/* Sidebar Header */}
        <div className="flex items-center justify-between p-4 border-b min-w-[256px] md:min-w-0">
          {/* <div className={`text-xl font-bold text-red-600 ${!sidebarOpen && 'md:hidden'}`}>
            MyTube
          </div> */}
          {/* <div className={`text-xl font-bold text-red-600 ${sidebarOpen && 'md:hidden'}`}>
            MT
        ...
        {/* Navigation */}
        <nav className="p-4 space-y-2 flex-1 min-w-[256px] md:min-w-0">
          <NavLink
            to="/Home"
            className={({ isActive }) =>
          ...
          >
            <span className={`${!sidebarOpen && 'md:hidden'}`}>🎥My Videos</span>
          </NavLink> */}
